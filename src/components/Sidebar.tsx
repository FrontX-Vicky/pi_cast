        ...
        <nav className="mt-5 px-4 lg:mt-4 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === '/pis' || pathname.includes('pis')
                }
              >
                {(handleClick, open) => {
                  return (
              ...
              {/* <li>
                <NavLink
                  to="/Employee/CreateEmp"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes('Create-Emp') && 'bg-graydark dark:bg-meta-4'
                    }`}
                >
                  <RiContactsLine />
                  Create Emp
