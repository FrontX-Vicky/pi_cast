    ...
    return (
        <>
            ...
            <div className="relative overflow-x-auto shadow-md sm:rounded-lg">
                <button
                    className="font-bold absolute top-2 right-2 bg-gray text-black dark:text-white dark:bg-black border-2 border-white rounded-lg px-2 py-2"
                    onClick={() => createClassRoom()}
                >
                    Create Class
                </button>
                <button
                    className="font-bold absolute top-2 right-30 bg-gray text-black dark:text-white dark:bg-black  border-2 border-white rounded-lg px-2 py-2"
                    ...
                    <tbody>
                        {BatchClassRoom &&
                            BatchClassRoom.filter((item) =>
                                ...
                                <tr
                                    key={i}
                                    className="bg-white dark:bg-black border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200"
                                >
                                    <td className="px-6 py-4 font-medium text-gray-900 whitespace-nowrap text-black dark:text-white">
                                        {item['batch']}
                                    </td>
